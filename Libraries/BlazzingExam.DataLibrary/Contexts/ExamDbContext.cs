...
namespace BlazzingExam.DataLibrary.Contexts
{
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Permission>(p =>
            {
                p.HasData(new[]
                {
                    ...
                    //----------------------------------------------------------
                    //new Permission(16,"حذف کاربر", 2),
                    //new Permission(17,"حذف کاربر", 2),
                    //new Permission(18,"حذف کاربر", 2),
                    //new Permission(19,"حذف کاربر", 2),
                });
            });
